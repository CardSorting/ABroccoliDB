...
export async function syncDirectory(directory) {
    ...
    try {
        ...
        if (["EINVAL", "ENOTSUP", "ENOSYS"].includes(fileError.code ?? ""))
            return;
        throw error;
    }
    finally {
...
export async function ensureDirectoryDurably(directory) {
...
export async function writeFileAtomically(filePath, data) {
...
//# sourceMappingURL=broccolidb-fs.js.map